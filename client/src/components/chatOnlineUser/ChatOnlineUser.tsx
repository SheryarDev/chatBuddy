...
const ChatOnlineUser = () => {
  ...
  return (
    <Box sx={{borderLeft:"1px solid lightgray",borderColor:"secondary.main",height:"95%",minHeight:"535px",px:2,py:2}}>
        <Paper  sx={{height:"100%",border:"1px solid lightgray",borderColor:"secondary.main",p:2,mt:2,borderRadius:"12px",maxHeight:"475px"}}>
